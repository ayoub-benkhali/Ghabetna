...
from app.schemas.assignment_schema import AssignmentResponse,AssignRequest
from sqlalchemy.ext.asyncio import AsyncSession
from app.services.assignment_service import _get_agent,_validate_parcelle
...
async def get_agents_for_parcelle(parcelle_id:int,db:AsyncSession=Depends(get_db),_:None=Depends(require_permission("assignment:create"))):
