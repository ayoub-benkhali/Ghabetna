...
class ForestRepository {
  ...
  Future<ParcelleModel> createParcelle(int forestId,Map<String,dynamic>body) async{
    final r=await _dio.post('/api/forests/$forestId/parcelles',data: body);
    return ParcelleModel.fromJson(r.data);
  }

  Future<ParcelleModel> updateParcelle(int forestId,int parcelleId,Map<String,dynamic>body) async{
    final r=await _dio.put('/api/forests/$forestId/parcelles/$parcelleId',data: body);
    return ParcelleModel.fromJson(r.data);
  }

  Future<void> deleteParcelle(int forestId,int parcelleId)=>_dio.delete('/api/forests/$forestId/parcelles/$parcelleId');
}
